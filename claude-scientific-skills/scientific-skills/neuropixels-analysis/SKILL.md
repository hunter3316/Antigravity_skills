...
When using this skill with Claude Code, the agent can directly analyze waveform plots and provide expert curation decisions. For programmatic API access:
...
**Claude Code Integration**: When running within Claude Code, ask the agent to examine waveform/correlogram plots directly - no API setup required.

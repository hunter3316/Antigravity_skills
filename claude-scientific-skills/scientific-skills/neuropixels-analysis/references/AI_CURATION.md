...
When using this skill within Claude Code, the agent can directly analyze waveform plots without requiring API setup. Simply:

1. Generate a unit report or plot
2. Ask the agent to analyze the visualization
3. the agent will provide expert-level curation decisions
